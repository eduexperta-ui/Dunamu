  ...
  useEffect(() => {
    ...
    const colors = {
      light: {
        ...
        highlight: 'rgba(2, 63, 151, 1)', // brand blue - fully opaque when highlighted
      },
      dark: {
        background: '#000000', // black
        particle: 'rgba(107, 114, 128, 0.8)', // gray-500
        line: 'rgba(55, 65, 81, 0.6)', // gray-700
        highlight: 'rgba(2, 63, 151, 1)', // brand blue
      }
    };
        ...
        for (let a = 0; a < particles.length; a++) {
            for (let b = a + 1; b < particles.length; b++) {
                ...
                if (distance < 120) {
                    ...
                    if (isLineHovered) {
                        ctx.strokeStyle = `rgba(2, 63, 151, ${opacity})`; // Brand Blue
                    } else {
                        // Default logic
                        if (theme === 'dark') {
