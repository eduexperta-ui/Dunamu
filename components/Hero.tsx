      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 sm:px-8 flex flex-col justify-center h-full">
        <div className="w-full">
          <h1 className="tracking-tighter flex flex-col items-start break-keep text-left">
            ...
            {/* 메인 타이틀 */}
            <span className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-medium text-brand dark:text-white mt-2 leading-none">
              {PERSONAL_INFO.title_line3}
            </span>
            {/* 이름 섹션 */}
            <span className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-brand dark:text-brand mt-1 sm:mt-2 leading-none block">
              {PERSONAL_INFO.name}
            </span>
          </h1>
