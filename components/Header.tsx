            ...
            <nav className="flex items-center gap-x-8">
              {NAV_LINKS.map(link => (
                <a 
                    ...
                    className="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-brand dark:hover:text-brand transition-colors"
                >
                  {link.name}
                </a>
              ))}
          ...
          <div className="md:hidden fixed inset-0 z-40 bg-white/95 dark:bg-black/95 backdrop-blur-md flex flex-col items-center justify-start pt-24 h-[100dvh] animate-fadeIn">
            <nav className="flex flex-col items-center gap-8 w-full">
              {NAV_LINKS.map(link => (
                <a 
                    ...
                    href={link.href} 
                    onClick={(e) => handleNavClick(e, link.href)}
                    className="text-2xl font-bold text-gray-900 dark:text-white hover:text-brand dark:hover:text-brand transition-colors w-full text-center py-2"
                >
                  {link.name}
                </a>
              ))}
            ...
            <div className="mt-12 flex items-center gap-x-8">
              <button 
                ...
                className="flex flex-col items-center gap-2 text-gray-800 dark:text-gray-200 hover:text-brand dark:hover:text-brand" 
